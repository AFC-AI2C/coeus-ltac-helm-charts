...
| `image.repository` | Image repository | `ltac.dev.local:5000/jetstack/cert-manager-controller` |
...
| `webhook.image.repository` | Webhook image repository | `ltac.dev.local:5000/jetstack/cert-manager-webhook` |
...
| `cainjector.image.repository` | cainjector image repository | `ltac.dev.local:5000/jetstack/cert-manager-cainjector` |
...
| `startupapicheck.image.repository` | startupapicheck image repository | `ltac.dev.local:5000/jetstack/cert-manager-ctl` |
